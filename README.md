...
- **Website:** https://www.theadarsh.dev  
- **Phone:** +91 8984352779  
...
All information you enter—such as fitness data, nutrition logs, sleep records, or wellness details—is stored **only on your device** using local storage.
...
- Avoid using the app on compromised or rooted devices  

The developer is not responsible for unauthorized access resulting from inadequate device security.
...
- You can delete your data at any time by clearing app storage or uninstalling the app  
...
As no personal data is collected or processed, most regulatory obligations do not apply beyond transparency and user control.
...
- Any damages resulting from misuse of the app  

Users are responsible for safeguarding their own devices and data.
...
- The app complies with **COPPA** and **Google Play Families Policy**  

If you believe a child has used the app in a way that violates these principles, please contact the developer.
...
- New features (such as optional cloud sync)  
...
- Publicly accessible via a valid URL  
- Available in the app and app store listing  
- Readable in a standard web browser without special tools  
